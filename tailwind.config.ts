		...
		extend: {
			colors: {
				...
				farm: {
					...
					'temp-hot': 'hsl(var(--temperature-hot))',
					'temp-normal': 'hsl(var(--temperature-normal))',
					'temp-cold': 'hsl(var(--temperature-cold))'
				},
				sidebar: {
			...
			keyframes: {
				...
				// Small periodic hop animation (short bounce then rest)
				hop: {
				...
				// Gentle slow scale pulse every 4s
				'scale-pulse': {
